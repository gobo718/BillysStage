...
test('migration domains remain defined',()=>{const sql=fs.readFileSync(path.resolve('engine/service/worker/migrations/0001_initial.sql'),'utf8');for(const table of ['users','user_settings','mashup_progress','blurblet_votes','collections','collection_items','curator_blurblets'])assert.match(sql,new RegExp(`CREATE TABLE IF NOT EXISTS ${table}\\b`))});
