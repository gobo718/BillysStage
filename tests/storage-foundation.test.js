...

{
  ...
  load(ctx, root + '/mashup-core.js');
  load(ctx, root + '/engine/platform/storage/storage.js');
  load(ctx, root + '/engine/game/publishing/curator-records.js');
  load(ctx, root + '/games/billyslab/content/curator-repository.js');
  load(ctx, root + '/engine/game/collections/collection-service.js');
  load(ctx, root + '/games/billyslab/content/collection-definitions.js');
  load(ctx, root + '/games/billyslab/content/collections-repository.js');
